...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, low_dim=128, in_channel=3, width=1):
        ...
        embedding_dim = self.base * 8 * block.expansion
...
def resnet18(low_dim=128, in_channel=3):
    return ResNet(BasicBlock, [2,2,2,2], in_channel=in_channel, low_dim=low_dim)


def resnet50(low_dim=128, in_channel=3):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    return ResNet(Bottleneck, [3,4,6,3], in_channel=in_channel, low_dim=low_dim)
