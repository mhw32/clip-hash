...
DATASET = {
    ...
    'multimodal_cifar10_big': MultimodalCIFAR10,
    'imagenet': ImageNet,
...
TRANSFORM = {
    ...
    'multimodal_cifar10_big': load_imagenet_transforms,
...
def get_datasets(
    root, dataset_name, bert_model='deberta-v3-base', max_seq_len=512):
    """
